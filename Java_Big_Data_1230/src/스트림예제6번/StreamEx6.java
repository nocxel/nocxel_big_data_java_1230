...
public class StreamEx6 {
    public static void main(String[] args) {
        ...
        // reduce() : 첫 번째 요소와 두 번째 요소를 가지고 연산을 수행 후, 그 결과를 세 번째 요소를 가지고 다시 연산
        ...
        OptionalInt rst3 = stream5.sorted().findAny(); // 병렬처리 포함되어있음 그래서 첫번째 안나올 수도?
        ...
        System.out.println(stream6.anyMatch(n -> n > 30));
        System.out.println(stream7.allMatch(n -> n> 20));
        System.out.println(stream8.noneMatch(n -> n > 100));
        ...
        System.out.println(stream12.average());
    }
